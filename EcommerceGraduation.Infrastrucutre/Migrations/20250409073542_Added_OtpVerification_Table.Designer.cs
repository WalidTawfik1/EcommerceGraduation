...
namespace EcommerceGraduation.Infrastrucutre.Migrations
{
    ...
    [Migration("20250409073542_Added_OtpVerification_Table")]
    partial class Added_OtpVerification_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceGraduation.Core.Entities.Customer", b =>
                {
                    ...
                    b.HasIndex(new[] { "Id" }, "UQ__Customer__066785210EEA4C72")
                        .IsUnique();
            ...
            modelBuilder.Entity("EcommerceGraduation.Core.Entities.OtpVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EcommerceGraduation.Core.Entities.Customer", null)
                        .WithMany()
